...
public class ProfileActivity extends AppCompatActivity {
                    ...
                    if (!queryDocumentSnapshots.isEmpty()) {
                        ...
                        documentReference.update(updateData)
                                .addOnSuccessListener(aVoid -> {
                                    ...
                                    Toast.makeText(ProfileActivity.this, "Boolean status and borrower's name updated successfully", Toast.LENGTH_SHORT).show();
                                })
                                .addOnFailureListener(e -> {
                                    Log.e("infodia", "Boolean status and borrower's name update failed: " + e.getMessage());
                                    Toast.makeText(ProfileActivity.this, "Boolean status and borrower's name update failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                });
                    } else {
                        // No matching document found
                        Log.d("infodia", "No matching document found");
                        Toast.makeText(ProfileActivity.this, "No matching document found", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(e -> {
                    Log.e("infodia", "Firestore query failed: " + e.getMessage());
                    Toast.makeText(ProfileActivity.this, "Firestore query failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
    ...
    private void setListeners() {
        ...
        binding.ivUserEdit.setOnClickListener(v -> openImagePicker());
        binding.btnUpdate.setOnClickListener(v -> updateUserDetails());
        binding.btnChangePassword.setOnClickListener(v -> openChangePasswordActivity());
    }
    ...
    private void openImagePicker() {
        ...
        startActivityForResult(intent, Constants.REQUEST_CODE_IMAGE_PICKER);
    }

    private void updateUserDetails() {
        String updatedUserName = binding.etUserNameEdit.getText().toString().trim();
        ...
        updatedUser.put(Constants.KEY_NAME, updatedUserName);
    ...
    private void showProgress() {
        ...
        binding.ivUserEdit.setEnabled(false);
    }
    ...
    private void hideProgress() {
        ...
        binding.ivUserEdit.setEnabled(true);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == Constants.REQUEST_CODE_IMAGE_PICKER && resultCode == RESULT_OK && data != null) {
    ...
    private void updateUserImage(String encodedImage) {
        ...
        userRef.update(updatedUser)
                ...
                .addOnFailureListener(e -> {
                    showToast("Failed to update profile image. Please try again later.");
                    //hideProgress();
                });
    }
}
