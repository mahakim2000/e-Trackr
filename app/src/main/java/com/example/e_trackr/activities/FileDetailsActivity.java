                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (!borrowerName.isEmpty()) {
                            ...
                            Toast.makeText(FileDetailsActivity.this, "Name cannot be empty", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
                    ...
                    if (!queryDocumentSnapshots.isEmpty()) {
                        ...
                        documentReference.update(updateData)
                                .addOnSuccessListener(aVoid -> {
                                    ...
                                    Toast.makeText(FileDetailsActivity.this, "Boolean status and borrower's name updated successfully", Toast.LENGTH_SHORT).show();
                                })
                                .addOnFailureListener(e -> {
                                    Log.e("infodia", "Boolean status and borrower's name update failed: " + e.getMessage());
                                    Toast.makeText(FileDetailsActivity.this, "Boolean status and borrower's name update failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                });
                    } else {
                        // No matching document found
                        Log.d("infodia", "No matching document found");
                        Toast.makeText(FileDetailsActivity.this, "No matching document found", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(e -> {
                    Log.e("infodia", "Firestore query failed: " + e.getMessage());
                    Toast.makeText(FileDetailsActivity.this, "Firestore query failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
