...
import com.example.e_trackr.databinding.ActivityInComingBinding;
...
public class InComingActivity extends AppCompatActivity implements FileListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.incomingListActivityRecyclerView.setLayoutManager(layoutManager);
        getFileList();
        initViews();
    }
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (!borrowerName.isEmpty()) {
                            ...
                            Toast.makeText(InComingActivity.this, "Name cannot be empty", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
                    ...
                    if (!queryDocumentSnapshots.isEmpty()) {
                        ...
                        documentReference.update(updateData)
                                .addOnSuccessListener(aVoid -> {
                                    ...
                                    Toast.makeText(InComingActivity.this, "Boolean status and borrower's name updated successfully", Toast.LENGTH_SHORT).show();
                                })
                                .addOnFailureListener(e -> {
                                    Log.e("infodia", "Boolean status and borrower's name update failed: " + e.getMessage());
                                    Toast.makeText(InComingActivity.this, "Boolean status and borrower's name update failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                });
                    } else {
                        // No matching document found
                        Log.d("infodia", "No matching document found");
                        Toast.makeText(InComingActivity.this, "No matching document found", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(e -> {
                    Log.e("infodia", "Firestore query failed: " + e.getMessage());
                    Toast.makeText(InComingActivity.this, "Firestore query failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
    ...
    private void getFileList() {
        ...
        database.collection(Constants.KEY_COLLECTION_FILE_INFO)
                .whereEqualTo(Constants.KEY_INCOMING, true) // Add this condition
                .get()
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        if (files.size() > 0) {
                            ...
                            binding.incomingListActivityRecyclerView.setAdapter(filesAdapter4);
                            binding.incomingListActivityRecyclerView.setVisibility(View.VISIBLE);
                        } else {
                            showErrorMessage();
                        }
                    } else {
